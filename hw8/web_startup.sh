...
pip3 install flask google-cloud-storage requests

cat > /home/$USER/server.py <<'EOF'
...
[Service]
User=root
Environment=BUCKET_NAME=hw-2-486907-ankith07-pagerank-001
Environment=REPORT_URL=
...
systemctl enable hw8-web
systemctl start hw8-web